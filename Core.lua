...
UIStroke.Color = Color3.new(1, 1, 1) -- 严格改为纯白色
...
local function ShowConfirm(name, callback)
    ...
    yes.Size = UDim2.new(0.4, 0, 0.3, 0); yes.Position = UDim2.new(0.05, 0, 0.6, 0); yes.BackgroundColor3 = Color3.fromRGB(0, 150, 0); yes.Text = "运行"; yes.TextColor3 = Color3.new(1,1,1); Instance.new("UICorner", yes)
